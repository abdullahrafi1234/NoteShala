...
export const Sidebar = () => {
  ...
  // sectionId change হলে bookmark reload
  useEffect(() => {
        ...
        {bookmarkedSections.length > 0 && (
          <div className="mb-4">
            ...
            >
              ...
              <span className="truncate text-left">Bookmarks</span>
            ...
            {showBookmarks && (
              <div className="ml-4 mt-1 space-y-1 border-l-2 border-primary/30 pl-4 animate-fade-in">
                {bookmarkedSections
